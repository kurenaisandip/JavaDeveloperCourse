public class testing {
    ...
    public static void main(String[] args) {
        ...
        Car car = new Car(2021, "Mercrdes", engine); // so we have engine in the car because car cannot be created
                                                     // without engine so this is the relatiion between car and engine
